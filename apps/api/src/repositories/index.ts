...
export { IEmailVerificationTokenRepository } from './email-verification-token.repository';
...
export { MongooseEmailVerificationTokenRepository } from './adapters/mongoose-email-verification-token.repository';

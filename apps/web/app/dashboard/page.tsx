...
const overviewByRole: Record<UserRole, { title: string; description: string }> = {
  [UserRole.DJ]: {
    ...
    description:
      'Manage the profile, bookings, and payout details that help planners hire you.',
  },
  [UserRole.PLANNER]: {
    title: 'Your planner workspace',
    description:
      'Browse DJs, send booking requests, and manage upcoming event activity.',
  },
  [UserRole.MUSIC_LOVER]: {
    title: 'Your discovery workspace',
    description:
      'Keep track of artists, genres, and vibe profiles you want to explore next.',
  },
  [UserRole.ADMIN]: {
    title: 'Your admin workspace',
    description:
      'Inspect platform activity and support users across the marketplace.',
  },
};
